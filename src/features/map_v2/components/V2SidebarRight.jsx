...
export default function V2SidebarRight({
  ...
  return (
    <aside className="v2-sidebar v2-sidebar--right flex flex-col gap-4 w-[280px] shrink-0 p-4 bg-slate-950/80 border-l border-slate-800 backdrop-blur-md overflow-y-auto">
